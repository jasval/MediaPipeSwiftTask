...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/jaspers-valdivia/MediaPipeSwiftTask/releases/download/v1.0.0/MediaPipeTasksGenAI.xcframework.zip",
            checksum: "df3a5291db8f692a20755f8da57d0b4ba3c8de0d11d9aaa91ef4c1c437f1ceb1"
        ),
        .binaryTarget(
            name: "MediaPipeTasksGenAIC", 
            url: "https://github.com/jaspers-valdivia/MediaPipeSwiftTask/releases/download/v1.0.0/MediaPipeTasksGenAIC.xcframework.zip",
