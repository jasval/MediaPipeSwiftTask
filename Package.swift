...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/jasval/MediaPipeSwiftTask/releases/download/v1.0.1/MediaPipeTasksGenAI.xcframework.zip",
            checksum: "76b850b0e66554f9c0adf249e41ba2ee1f22fa057e9c0e94c8a98a610e3b9a01"
        ),
        .binaryTarget(
            name: "MediaPipeTasksGenAIC", 
            url: "https://github.com/jasval/MediaPipeSwiftTask/releases/download/v1.0.1/MediaPipeTasksGenAIC.xcframework.zip",
